            ...
            <div class="row">
                <div class="col-sm-12" style=" height:425px; background-color: chartreuse; margin-top: -20px; margin-bottom: 0px;padding: 50px 0px 30px 100px;">              
                    <div class="search-container col-lg-offset-2" style="margin-bottom: 20px;">
                       <form>
                           <h1 style="color: white;">Message send to Apan</h1>
                            <button type="button" class="btn-danger">Name</button>
                        
                            <input type="text" placeholder="Name.." name="search" style="margin-top:12px;">
                            <button type="submit"><i class="glyphicon glyphicon-search"></i></button>
                        </form>
                        <form>
                            
                            <button type="button" class="btn-danger">From</button>                       
                            <input type="date" placeholder="From.." name="search" style="margin-top:12px;">
                            <!--<button type="submit"></button>-->
                            <button type="button" class="btn-danger">To</button>                       
                            <input type="date" placeholder="To.." name="search" style="margin-top:12px;">
                            <button type="submit"><i class="glyphicon glyphicon-search"></i></button>
                        </form>
                    </div>
